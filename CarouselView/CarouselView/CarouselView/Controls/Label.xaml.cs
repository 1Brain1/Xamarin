...
namespace CarouselView.Controls
{
    ...
    public partial class Label
    {
        ...
        public static readonly BindableProperty FontAttributesProperty =
            BindableProperty.Create(nameof(FontAttributes), typeof(FontAttributes), typeof(Label), FontAttributes.Bold,
                BindingMode.TwoWay);

        public static readonly BindableProperty TextTransformProperty =
            BindableProperty.Create(nameof(TextTransform), typeof(TextTransform), typeof(Label),
